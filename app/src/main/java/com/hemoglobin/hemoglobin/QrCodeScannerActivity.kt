...
class QrCodeScannerActivity : AppCompatActivity(), ZXingScannerView.ResultHandler {
    ...
    companion object {
        ...
        fun getScanQrCodeActivity(callingClassContext: Context) = Intent(callingClassContext, QrCodeScannerActivity::class.java)
    }
    ...
    private fun resumeCamera() {
        Toast.LENGTH_LONG
        val handler = Handler()
        handler.postDelayed({ qrCodeScanner.resumeCameraPreview(this@QrCodeScannerActivity) }, 2000)
    }
